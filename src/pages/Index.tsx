...
const googleMapsUrl = "https://www.google.com/maps/search/?api=1&query=Asociacion+Mexicana+de+Barberia+Queretaro8";
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="w-full h-80 bg-gray-800 rounded-xl overflow-hidden">
            <iframe
                src="https://www.google.com/maps/search/?api=1&query=Asociacion+Mexicana+de+Barberia+Queretaro9"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
