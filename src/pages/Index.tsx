...
const googleMapsUrl = "https://maps.app.goo.gl/u5f5k5f5f5f5f5f55";
  ...
  function MasterCoursesSection({ coursesData }: { coursesData: typeof masterCourses }) {
    return (
      <section className="relative py-20 text-white">
          <div className="absolute inset-0 z-0">
              <img src="/images/master-bg.jpg" alt="Fondo de Cursos Master" className="w-full h-full object-cover"/>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {coursesData.map((course, index) => (
              <div key={index} className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-6 text-center border border-gray-700 shadow-lg transition-transform hover:scale-105 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
